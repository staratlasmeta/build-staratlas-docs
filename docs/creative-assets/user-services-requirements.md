...
* **Royalties.** For revenue generated (whether received by you or others) beyond the first $1 million USD in lifetime Gross Revenue, you will need to pay certain [**Royalties**](/creative-assets/royalties). You will also need to fill out a **Royalties Form** (coming soon) and contact us for further information on payment.
...
* **ATLAS, POLIS, and Star Atlas NFT Integration.** If feasible and practical, you must accept ATLAS and/or POLIS as a payment option and integrate the use of Star Atlas NFTs. Payment implementation options include:
  * [**NOWPayments**](https://nowpayments.io/blog/atlas-announcement?utm_source=twitter\&utm_medium=social\&utm_campaign=atlas-announcement) to accept ATLAS
  * [**Solana Pay**](https://solanapay.com/) to accept ATLAS or POLIS
